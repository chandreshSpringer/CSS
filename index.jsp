...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="resources/${applicationVersion}/js/resources/css/xcp-default-rtl-debug.css"/>
    <% } else { %>
    <link rel="stylesheet" type="text/css"
          href="resources/${applicationVersion}/js/resources/css/xcp-default-debug.css"/>
    <% } %>
    <% } else { %>
    <% if (rtl) { %>
    ...
    <script type="text/javascript"
            src="resources/${applicationVersion}/js/firebug-lite/dist/xcp-firebug-lite.js"></script>
    <% } %>
    ...
    <script type="text/javascript"
            src="resources/${applicationVersion}/js/ext-4.2/src/diag/layout/ContextItem.js"></script>
    <% } %>

    <script type="text/javascript"
            src="resources/${applicationVersion}/js/ext-4.2/locale/ext-lang-<%=extLangFileSuffix%>.js"></script>
    ...
    <% if (nominify) { %>
    <script id="xcp_startup" type="text/javascript"
            src="component/xcp-core/xcp_startup/contents-xcp_startup-${applicationVersion}.js?nominify=true&locale=<%=lang%>"></script>
    <% } else { %>
    <script id="xcp_startup" type="text/javascript"
            src="component/xcp-core/xcp_startup/contents-xcp_startup-${applicationVersion}.js?locale=<%=lang%>"></script>
    <% } %>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("keyup", function (event) {
            if (event.keyCode === 13) {
                ...
                var buttons = document.querySelectorAll(".ent3r_captur3_c1a88_un1qu3_butt0n a");
                if(buttons.length==0){
                    console.log('NO Button  found with class ent3r_captur3_c1a88_un1qu3_butt0n');
                }
                else{
                ...
                buttons.forEach(function (button) {
                    if (isHidden(button)) {
                        console.log('Button  found but hidden with class ent3r_captur3_c1a88_un1qu3_butt0n');
                    } else {
